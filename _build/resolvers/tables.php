...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modx->addPackage('msorderaddressmap', MODX_CORE_PATH . 'components/msorderaddressmap/model/');
            $manager = $modx->getManager();
            $objects = [];
            $schemaFile = MODX_CORE_PATH . 'components/msorderaddressmap/model/schema/msorderaddressmap.mysql.schema.xml';
